...
export const waterReadings: WaterReading[] = [
  ...
  { id: 'WR-7003-C', residentId: 'R-1005', apartmentId: 'apt-b-41', month: '2026-05', waterType: 'cold', previousValue: 1530, currentValue: 1572 },
  { id: 'WR-7003-H', residentId: 'R-1005', apartmentId: 'apt-b-41', month: '2026-05', waterType: 'hot', previousValue: 210, currentValue: 215 },
